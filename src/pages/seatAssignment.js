...
function SeatAssignment({ seats, setSeats }) {
  ...
  const 자리배정 = async () => {
    ...
    await axios({
      url: "http://localhost:4000/seatAssignment",
      method: "POST",
      data: {
        number: number,
        date: date,
    ...
    <div className="main-map-left">
      ...
      <div className="seat seat-H">
        ...
        <div className="seat-flex">
          <button type="button" className="menu menus" onClick={자리배정}>
            자리배정
          </button>
