  ...
  return (
    <div className="유의사항">
      ...
      <div className="유의-세부내용">
        <br />
        가. 20분이 초과하게 되면 해당 카드로는 더이상 출입이 불가능하게 됩니다.
      </div>
      <div className="유의-세부내용">
        <br />
      ...
      <br />
      <br />
      <div className="유의-부제목">Ⅲ. Campus에서는 반드시 조용히 해주세요</div>
      <br />
      <div className="유의-내용">
        1. 주변에 열심히 공부하는 친구들을 위한 기본적인 에티켓을 꼭 지켜주시기
        바랍니다.
      </div>
      <br />
      <div className="유의-내용">
      ...
      <br />
      <div className="유의-내용">
        3. 키오스크가 있는 공간에 모니터에서 CCTV로 촬영중인 화면을 실시간으로
        확인 가능합니다.
      </div>
      <br />
      <div className="유의-내용">
